...
// in simulator we redefine to format for InsuranceApp Developer console
...
{\
	NSString * exceptionName = [@"org.insuranceapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.insuranceapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIInsuranceAppNativeItemNone = -1, 
	UIInsuranceAppNativeItemSpinner = -2,
	UIInsuranceAppNativeItemProgressBar = -3,
	
	UIInsuranceAppNativeItemSlider = -4,
	UIInsuranceAppNativeItemSwitch = -5,
	UIInsuranceAppNativeItemMultiButton = -6,
	UIInsuranceAppNativeItemSegmented = -7,
	
	UIInsuranceAppNativeItemTextView = -8,
	UIInsuranceAppNativeItemTextField = -9,
	UIInsuranceAppNativeItemSearchBar = -10,
	
	UIInsuranceAppNativeItemPicker = -11,
	UIInsuranceAppNativeItemDatePicker = -12,
	
	UIInsuranceAppNativeItemInfoLight = -13,
	UIInsuranceAppNativeItemInfoDark = -14,
	
	UIInsuranceAppNativeItemDisclosure = -15,
	
	UIInsuranceAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all InsuranceApp instances of
