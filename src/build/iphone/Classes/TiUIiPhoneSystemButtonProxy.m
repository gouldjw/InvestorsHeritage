...
MAKE_SYSTEM_PROP(ACTIVITY,UIInsuranceAppNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIInsuranceAppNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIInsuranceAppNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIInsuranceAppNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIInsuranceAppNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIInsuranceAppNativeItemContactAdd);
