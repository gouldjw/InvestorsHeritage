...
//Rare exceptions to indicate a bug in the _insuranceapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for InsuranceApp proxies.
 */
