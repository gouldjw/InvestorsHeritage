...
/**
 The base class for all PremiumCalc modules
 */
...
/**
 PremiumCalc Platform calls this method on startup.
 */
-(void)startup;

/**
 PremiumCalc Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 PremiumCalc Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 PremiumCalc Platform calls this method on resume.
 @param sender The sender of the event.
 */
