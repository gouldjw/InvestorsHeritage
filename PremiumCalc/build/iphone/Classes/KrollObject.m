 ...
 * Copyright (c) 2009-2011 by PremiumCalc, Inc. All Rights Reserved.
...
//@interface PremiumCalcObject : NSObject
//@end

@interface PremiumCalcObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PremiumCalcObject class]])
		{
			for (NSString *key in [[(PremiumCalcObject*)o modules] allKeys])
			{
