...
@interface PremiumCalcObject : KrollCoverageObject {
#else
@interface PremiumCalcObject : KrollObject {
#endif
@private
...
extern NSString * PremiumCalc$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PremiumCalcObject *_premiumcalc;
	BOOL shutdown;
