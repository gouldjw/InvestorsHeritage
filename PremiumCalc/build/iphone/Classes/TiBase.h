...
// in simulator we redefine to format for PremiumCalc Developer console
...
{\
	NSString * exceptionName = [@"org.premiumcalc." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.premiumcalc";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIPremiumCalcNativeItemNone = -1, 
	UIPremiumCalcNativeItemSpinner = -2,
	UIPremiumCalcNativeItemProgressBar = -3,
	
	UIPremiumCalcNativeItemSlider = -4,
	UIPremiumCalcNativeItemSwitch = -5,
	UIPremiumCalcNativeItemMultiButton = -6,
	UIPremiumCalcNativeItemSegmented = -7,
	
	UIPremiumCalcNativeItemTextView = -8,
	UIPremiumCalcNativeItemTextField = -9,
	UIPremiumCalcNativeItemSearchBar = -10,
	
	UIPremiumCalcNativeItemPicker = -11,
	UIPremiumCalcNativeItemDatePicker = -12,
	
	UIPremiumCalcNativeItemInfoLight = -13,
	UIPremiumCalcNativeItemInfoDark = -14,
	
	UIPremiumCalcNativeItemDisclosure = -15,
	
	UIPremiumCalcNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PremiumCalc instances of
