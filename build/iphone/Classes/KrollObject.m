 ...
 * Copyright (c) 2009-2011 by insuranceapp, Inc. All Rights Reserved.
...
//@interface insuranceappObject : NSObject
//@end

@interface insuranceappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[insuranceappObject class]])
		{
			for (NSString *key in [[(insuranceappObject*)o modules] allKeys])
			{
