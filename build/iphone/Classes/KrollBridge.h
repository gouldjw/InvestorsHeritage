...
@interface insuranceappObject : KrollCoverageObject {
#else
@interface insuranceappObject : KrollObject {
#endif
@private
...
extern NSString * insuranceapp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	insuranceappObject *_insuranceapp;
	BOOL shutdown;
