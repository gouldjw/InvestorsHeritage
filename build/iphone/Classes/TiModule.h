...
/**
 The base class for all insuranceapp modules
 */
...
/**
 insuranceapp Platform calls this method on startup.
 */
-(void)startup;

/**
 insuranceapp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 insuranceapp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 insuranceapp Platform calls this method on resume.
 @param sender The sender of the event.
 */
